 ...
 *
 * The effective builder-fee recipient (BUILDER_FEE_RECIPIENT, or PROTOCOL_TREASURY as
 * fallback) must hold at least 100 USDC of perp account value on Hyperliquid BEFORE any
 * room is created: HL rejects builder-fee approvals for poorer builders, and
 * GameRoomFactory.createRoom reverts with BuilderNotEligible below that threshold.
 *
